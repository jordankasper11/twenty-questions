...
namespace TwentyQuestions.Data.Utilities
{
    public static class MimeUtility
    {
        private static Dictionary<string, string> MimeMappings;
        ...
        public static string GetMimeType(string fileExtension)
        {
            ...
            if (MimeMappings.TryGetValue(fileExtension, out string mimeType))
                return mimeType;
        ...
        {
            var fileExtension = MimeMappings.FirstOrDefault(m => m.Value.Equals(mimeType, StringComparison.OrdinalIgnoreCase)).Key;
        ...
        private static void AddMapping(string fileExtension, string mimeType)
        {
            fileExtension = $".{fileExtension.TrimStart('.')}".ToLower();

            MimeMappings.Add(fileExtension, mimeType);
        }
    }
}
